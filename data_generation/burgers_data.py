...
from data_generation import method_of_lines
from data_generation.gaussian_process import generate_random_functions_with_bc
...
def burgers_data_generator(count):
    ...
    # defining the PDE
    f = lambda u, u_x, u_xx: nu * u_xx - u * u_x
